...
class Swiper extends React.Component {
  ...
  calculateOverlayLabelStyle = () => {
    let externalStyles = this.styles.overlayLabel;
    let dynamicStyles = {};
    ...
    if (labelProps && this.state.labelType !== LABEL_TYPES.NONE) {
      ...
      externalStyles = this.styles.hideOverlayLabel;
    }
  ...
  calculateOverlayLabelWrapperStyle = () => {
    ...
    return [this.styles.overlayLabelWrapper, dynamicStyles, { opacity }];
  }
  ...
  renderChildren() {
    ...
    return (
      <View style={[this.styles.childrenViewStyle, { zIndex: zIndex }]}>
        {children}
      </View>
    );
  }
